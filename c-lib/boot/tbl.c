...
AsnLen BEncTBLRangeContent PARAMS((b, v), BUF_TYPE b _AND_ TBLRange* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLRangeContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLRange* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
...
void PrintTBLRange PARAMS((f, v, indent), FILE* f _AND_ TBLRange* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLRange PARAMS((v), TBLRange* v)
{
	if (v == NULL)
		return;
	FreeAsnInt((&v->from));
...
AsnLen BEncTBLNamedNumberContent PARAMS((b, v), BUF_TYPE b _AND_ TBLNamedNumber* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLNamedNumberContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLNamedNumber* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
	...
	if (((tagId1 == MAKE_TAG_ID(CNTX, PRIM, 0)) || (tagId1 == MAKE_TAG_ID(CNTX, CONS, 0))))
	{
		elmtLen1 = BDecLen(b, &totalElmtsLen1, env);
...
void PrintTBLNamedNumber PARAMS((f, v, indent), FILE* f _AND_ TBLNamedNumber* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLNamedNumber PARAMS((v), TBLNamedNumber* v)
{
	if (v == NULL)
		return;
...
AsnLen BEncTBLNamedNumberListContent PARAMS((b, v), BUF_TYPE b _AND_ TBLNamedNumberList* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLNamedNumberListContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLNamedNumberList* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLNamedNumberList PARAMS((f, v, indent), FILE* f _AND_ TBLNamedNumberList* v _AND_ unsigned short indent)
{
	TBLNamedNumber* tmp;
	if (v == NULL)
		return;
...
void FreeTBLNamedNumberList PARAMS((v), TBLNamedNumberList* v)
{
	AsnListNode* l;
	AsnListNode* tmp;
	if (v == NULL)
...
AsnLen BEncTBLTypeRefContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTypeRef* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeRefContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTypeRef* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLTypeRef PARAMS((f, v, indent), FILE* f _AND_ TBLTypeRef* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLTypeRef PARAMS((v), TBLTypeRef* v)
{
	if (v == NULL)
		return;
...
AsnLen BEncTBLTagContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTag* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTagContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTag* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLTag PARAMS((f, v, indent), FILE* f _AND_ TBLTag* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLTag PARAMS((v), TBLTag* v)
{
	if (v == NULL)
		return;
...
AsnLen BEncTBLTypeSeqOfContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTypeSeqOf* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeSeqOfContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTypeSeqOf* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLTypeSeqOf PARAMS((f, v, indent), FILE* f _AND_ TBLTypeSeqOf* v _AND_ unsigned short indent)
{
	TBLTag* tmp;
	if (v == NULL)
		return;
...
void FreeTBLTypeSeqOf PARAMS((v), TBLTypeSeqOf* v)
{
	AsnListNode* l;
	AsnListNode* tmp;
	if (v == NULL)
...
AsnLen BEncTBLTypeContentSeqOfContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTypeContentSeqOf* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeContentSeqOfContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTypeContentSeqOf* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLTypeContentSeqOf PARAMS((f, v, indent), FILE* f _AND_ TBLTypeContentSeqOf* v _AND_ unsigned short indent)
{
	TBLType* tmp;
	if (v == NULL)
		return;
...
void FreeTBLTypeContentSeqOf PARAMS((v), TBLTypeContentSeqOf* v)
{
	AsnListNode* l;
	AsnListNode* tmp;
	if (v == NULL)
...
AsnLen BEncTBLTypeContent PARAMS((b, v), BUF_TYPE b _AND_ TBLType* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLType* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
	...
	if ((!seqDone) && ((tagId1 == MAKE_TAG_ID(CNTX, PRIM, 4)) || (tagId1 == MAKE_TAG_ID(CNTX, CONS, 4))))
	{
		elmtLen1 = BDecLen(b, &totalElmtsLen1, env);
...
void PrintTBLType PARAMS((f, v, indent), FILE* f _AND_ TBLType* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLType PARAMS((v), TBLType* v)
{
	if (v == NULL)
		return;
...
AsnLen BEncTBLTypeContentContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTypeContent* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeContentContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTypeContent* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLTypeContent PARAMS((f, v, indent), FILE* f _AND_ TBLTypeContent* v _AND_ unsigned short indent)
{
	switch (v->choiceId)
	{
		case TBLTYPECONTENT_PRIMTYPE:
...
void FreeTBLTypeContent PARAMS((v), TBLTypeContent* v)
{
	if (v == NULL)
		return;
	switch (v->choiceId)
...
AsnLen BEncTBLTypeDefContent PARAMS((b, v), BUF_TYPE b _AND_ TBLTypeDef* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLTypeDefContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLTypeDef* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
	...
	if (((tagId1 == MAKE_TAG_ID(UNIV, PRIM, PRINTABLESTRING_TAG_CODE)) || (tagId1 == MAKE_TAG_ID(UNIV, CONS, PRINTABLESTRING_TAG_CODE))))
	{
		elmtLen1 = BDecLen(b, &totalElmtsLen1, env);
...
void PrintTBLTypeDef PARAMS((f, v, indent), FILE* f _AND_ TBLTypeDef* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLTypeDef PARAMS((v), TBLTypeDef* v)
{
	if (v == NULL)
		return;
...
AsnLen BEncTBLModuleSeqOfContent PARAMS((b, v), BUF_TYPE b _AND_ TBLModuleSeqOf* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLModuleSeqOfContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLModuleSeqOf* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLModuleSeqOf PARAMS((f, v, indent), FILE* f _AND_ TBLModuleSeqOf* v _AND_ unsigned short indent)
{
	TBLTypeDef* tmp;
	if (v == NULL)
		return;
...
void FreeTBLModuleSeqOf PARAMS((v), TBLModuleSeqOf* v)
{
	AsnListNode* l;
	AsnListNode* tmp;
	if (v == NULL)
...
AsnLen BEncTBLModuleContent PARAMS((b, v), BUF_TYPE b _AND_ TBLModule* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLModuleContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLModule* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLModule PARAMS((f, v, indent), FILE* f _AND_ TBLModule* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
...
void FreeTBLModule PARAMS((v), TBLModule* v)
{
	if (v == NULL)
		return;
	FreePrintableString((&v->name));
...
void BDecTBLSeqOfContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBLSeqOf* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBLSeqOf PARAMS((f, v, indent), FILE* f _AND_ TBLSeqOf* v _AND_ unsigned short indent)
{
	TBLModule* tmp;
	if (v == NULL)
		return;
...
void FreeTBLSeqOf PARAMS((v), TBLSeqOf* v)
{
	AsnListNode* l;
	AsnListNode* tmp;
	if (v == NULL)
...
AsnLen BEncTBL PARAMS((b, v), BUF_TYPE b _AND_ TBL* v)
{
	AsnLen l;
	BEncEocIfNec(b);
...
void BDecTBL PARAMS((b, result, bytesDecoded, env), BUF_TYPE b _AND_ TBL* result _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	AsnTag tag;
	AsnLen elmtLen1;
...
AsnLen BEncTBLContent PARAMS((b, v), BUF_TYPE b _AND_ TBL* v)
{
	AsnLen totalLen = 0;
	AsnLen itemLen;
	AsnLen listLen;
...
void BDecTBLContent PARAMS((b, tagId0, elmtLen0, v, bytesDecoded, env), BUF_TYPE b _AND_ AsnTag tagId0 _AND_ AsnLen elmtLen0 _AND_ TBL* v _AND_ AsnLen* bytesDecoded _AND_ ENV_TYPE env)
{
	int seqDone = FALSE;
	AsnLen totalElmtsLen1 = 0;
	AsnLen elmtLen1;
...
void PrintTBL PARAMS((f, v, indent), FILE* f _AND_ TBL* v _AND_ unsigned short indent)
{
	if (v == NULL)
		return;
