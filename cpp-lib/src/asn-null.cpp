...
//
// $Header: /develop30/common/esnacc1.7/SNACC/c++-lib/src/asn-null.cpp,v 1.1.1.1 2005/04/14 14:59:42 \ste Exp $
// $Log: asn-null.cpp,v $
...
SJson::Value AsnNull::JEnc() const
{
	return SJson::Value((int)0);
}
