...
namespace snacclib
{
	...
	class snacclib_AsyncInvokeRuntimeTest : public RuntimeTestBase
	{
	protected:
	...
	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsSucceedsBer)
	{
		AssertAsyncGetSettingsSucceeds(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsSucceedsJson)
	{
		AssertAsyncGetSettingsSucceeds(TransportEncoding::JSON);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsReturnsApplicationErrorBer)
	{
		AssertAsyncGetSettingsReturnsApplicationError(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsReturnsRejectJson)
	{
		AssertAsyncGetSettingsReturnsReject(TransportEncoding::JSON);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsTimesOutBer)
	{
		AssertAsyncGetSettingsTimesOut(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncGetSettingsTimesOutJson)
	{
		AssertAsyncGetSettingsTimesOut(TransportEncoding::JSON);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, LateAsyncResponseIsIgnoredAfterTimeoutBer)
	{
		AssertLateAsyncResponseIsIgnoredAfterTimeout(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, PauseRoseProcessingCompletesAsyncInvokeWithShutdownJson)
	{
		AssertPauseRoseProcessingCompletesAsyncInvokeWithShutdown(TransportEncoding::JSON);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncSendFailureIsReportedBer)
	{
		AssertAsyncSendFailureIsReported(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, AsyncSendFailureIsReportedJson)
	{
		AssertAsyncSendFailureIsReported(TransportEncoding::JSON);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, FireAndForgetDoesNotInvokeCallbackBer)
	{
		AssertFireAndForgetDoesNotInvokeCallback(TransportEncoding::BER);
	}

	TEST_F(snacclib_AsyncInvokeRuntimeTest, FireAndForgetIgnoresImmediateResponseJson)
	{
