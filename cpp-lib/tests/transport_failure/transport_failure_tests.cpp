...
namespace snacclib
{
	...
	class snacclib_TransportFailureRuntimeTest : public RuntimeTestBase
	{
	protected:
	...
	TEST_F(snacclib_TransportFailureRuntimeTest, DelayedResponseCanArriveAfterTimeoutWithoutBreakingNextCallJson)
	{
	...
	TEST_F(snacclib_TransportFailureRuntimeTest, MalformedInboundPayloadDoesNotDispatchHandlersBer)
	{
	...
	TEST_F(snacclib_TransportFailureRuntimeTest, MalformedInboundPayloadDoesNotDispatchHandlersJson)
	{
