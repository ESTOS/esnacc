...
namespace snacclib
{
	...
	class snacclib_InvokeContextRuntimeTest : public RuntimeTestBase
	{
	protected:
	...
	TEST_F(snacclib_InvokeContextRuntimeTest, InboundHandlerReceivesCustomInvokeContextBer)
	{
		AssertInboundHandlerReceivesCustomInvokeContext(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundHandlerReceivesCustomInvokeContextJson)
	{
		AssertInboundHandlerReceivesCustomInvokeContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundResponseSendReusesHandlerInvokeContextBer)
	{
		AssertInboundResponseSendReusesHandlerInvokeContext(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundResponseSendReusesHandlerInvokeContextJson)
	{
		AssertInboundResponseSendReusesHandlerInvokeContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundHandlerRejectReusesInvokeContextBer)
	{
		AssertInboundHandlerRejectReusesInvokeContext(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundHandlerRejectReusesInvokeContextJson)
	{
		AssertInboundHandlerRejectReusesInvokeContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundApplicationErrorReusesInvokeContextBer)
	{
		AssertInboundApplicationErrorReusesInvokeContext(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundApplicationErrorReusesInvokeContextJson)
	{
		AssertInboundApplicationErrorReusesInvokeContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundResponseSendFailureKeepsInvokeContextBer)
	{
		AssertInboundResponseSendFailureKeepsInvokeContextOnAttemptedSend(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, InboundResponseSendFailureKeepsInvokeContextJson)
	{
		AssertInboundResponseSendFailureKeepsInvokeContextOnAttemptedSend(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, UnknownInboundOperationRejectUsesCustomInvokeContextBer)
	{
		AssertUnknownInboundOperationRejectUsesCustomInvokeContext(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, UnknownInboundOperationRejectUsesCustomInvokeContextJson)
	{
		AssertUnknownInboundOperationRejectUsesCustomInvokeContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, UnparsableInboundDoesNotReachHandlerBer)
	{
		AssertUnparsableInboundDoesNotReachHandler(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, UnparsableInboundDoesNotReachHandlerJson)
	{
		AssertUnparsableInboundDoesNotReachHandler(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundCallerContextReachesTransportBer)
	{
		AssertOutboundCallerContextReachesTransport(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundCallerContextReachesTransportJson)
	{
		AssertOutboundCallerContextReachesTransport(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundStubCreatedContextReachesTransportBer)
	{
		AssertOutboundStubCreatedContextReachesTransport(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundStubCreatedContextReachesTransportJson)
	{
		AssertOutboundStubCreatedContextReachesTransport(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundCallerContextSurvivesUntilCallerScopeEndsBer)
	{
		AssertOutboundCallerContextSurvivesUntilCallerScopeEnds(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundCallerContextSurvivesUntilCallerScopeEndsJson)
	{
		AssertOutboundCallerContextSurvivesUntilCallerScopeEnds(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundEncodeFailureKeepsCallerContextJson)
	{
		AssertOutboundEncodeFailureStillUsesCallerContext(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, NoTransportReturnsTransportFailedForInvokeBer)
	{
		AssertNoTransportReturnsTransportFailedForInvoke(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, NoTransportReturnsTransportFailedForInvokeJson)
	{
		AssertNoTransportReturnsTransportFailedForInvoke(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, NoTransportReturnsTransportFailedForEventBer)
	{
		AssertNoTransportReturnsTransportFailedForEvent(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, NoTransportReturnsTransportFailedForEventJson)
	{
		AssertNoTransportReturnsTransportFailedForEvent(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundTransportFailureKeepsCallerContextBer)
	{
		AssertOutboundTransportFailureKeepsCallerContextOnSendAttempt(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundTransportFailureKeepsCallerContextJson)
	{
		AssertOutboundTransportFailureKeepsCallerContextOnSendAttempt(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundTimeoutKeepsCallerContextBer)
	{
		AssertOutboundTimeoutKeepsCallerContextOnRequestSend(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundTimeoutKeepsCallerContextJson)
	{
		AssertOutboundTimeoutKeepsCallerContextOnRequestSend(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundRemoteRejectKeepsCallerContextBer)
	{
		AssertOutboundRemoteRejectKeepsCallerContextOnRequestSend(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundRemoteRejectKeepsCallerContextJson)
	{
		AssertOutboundRemoteRejectKeepsCallerContextOnRequestSend(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundRemoteErrorKeepsCallerContextBer)
	{
		AssertOutboundRemoteErrorKeepsCallerContextOnRequestSend(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundRemoteErrorKeepsCallerContextJson)
	{
		AssertOutboundRemoteErrorKeepsCallerContextOnRequestSend(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundMalformedResponseKeepsCallerContextBer)
	{
		AssertOutboundMalformedResponseKeepsCallerContextThroughDecodeFailure(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundMalformedResponseKeepsCallerContextJson)
	{
		AssertOutboundMalformedResponseKeepsCallerContextThroughDecodeFailure(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanResultDoesNotBreakPendingInvokeBer)
	{
		AssertOrphanResultDoesNotBreakPendingInvoke(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanResultDoesNotBreakPendingInvokeJson)
	{
		AssertOrphanResultDoesNotBreakPendingInvoke(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanResultEmitsInboundResponseTelemetryBer)
	{
		AssertOrphanResultEmitsInboundResponseTelemetryWithoutPendingOperation(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanResultEmitsInboundResponseTelemetryJson)
	{
		AssertOrphanResultEmitsInboundResponseTelemetryWithoutPendingOperation(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanErrorDoesNotBreakPendingInvokeBer)
	{
		AssertOrphanErrorDoesNotBreakPendingInvoke(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanErrorDoesNotBreakPendingInvokeJson)
	{
		AssertOrphanErrorDoesNotBreakPendingInvoke(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanRejectDoesNotBreakPendingInvokeBer)
	{
		AssertOrphanRejectDoesNotBreakPendingInvoke(TransportEncoding::BER);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, OrphanRejectDoesNotBreakPendingInvokeJson)
	{
		AssertOrphanRejectDoesNotBreakPendingInvoke(TransportEncoding::JSON);
	}

	TEST_F(snacclib_InvokeContextRuntimeTest, CreateOutboundInvokeContextOptionalTimeout)
	{
	...
	TEST(snacclib_InvokeWireTimeoutTest, ClearInvokeTimeoutRestoresUnset)
	{
	...
	TEST(snacclib_InvokeContextInitTest, OutboundInitStoresExplicitOperationName)
	{
	...
	TEST(snacclib_InvokeContextInitTest, OutboundInitWithoutNameLeavesOperationNameEmpty)
	{
	...
	TEST(snacclib_InvokeContextInitTest, InboundInitResolvesOperationNameFromInvokeLookup)
	{
		SnaccRoseOperationLookup lookup;
	...
	TEST(snacclib_InvokeWireTimeoutTest, RoseInvokeJsonRoundTripPreservesTimeout)
	{
		ROSEInvoke invoke;
		invoke.invokeID = 1;
	...
	TEST(snacclib_InvokeWireTimeoutTest, InboundInitCopiesWireInvokeTimeout)
	{
		ROSEInvoke invoke;
		invoke.invokeID = 1;
		invoke.operationID = 43210;
	...
	TEST(snacclib_InvokeWireTimeoutTest, InboundInitWithoutWireTimeoutLeavesUnset)
	{
		ROSEInvoke invoke;
		invoke.invokeID = 1;
		invoke.operationID = 43210;
	...
	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundWireInvokeTimeoutReachesInboundHandlerJson)
	{
	...
	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundWireInvokeTimeoutReachesInboundHandlerBer)
	{
		InitializeEndpoints(TransportEncoding::BER);
	...
	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundDefaultInvokeTimeoutOmitsWireValueOnInbound)
	{
		InitializeEndpoints(TransportEncoding::JSON);
	...
	TEST_F(snacclib_InvokeContextRuntimeTest, OutboundFireAndForgetOmitsWireValueOnInbound)
	{
		InitializeEndpoints(TransportEncoding::JSON);
	...
	TEST(snacclib_InvokeContextInitTest, InboundResolvesOperationIdFromNameThenCanonicalContextName)
	{
		SnaccRoseOperationLookup lookup;
		RuntimeEndpoint endpoint{L"InvokeContextLookup", "invoke-context-session", lookup};
		endpoint.RegisterOperation(43210, "asnTestInboundName", 1, "TestModule", false);
