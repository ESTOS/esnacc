...
namespace snacclib
{
	...
	class snacclib_ClientInvokeBlockPolicyRuntimeTest : public RuntimeTestBase
	{
	protected:
	...
	TEST(snacclib_RemoteCapabilityModuleHelperTest, BuildRemoteModuleCapabilitiesPopulatesInvokeAndEventOpIds)
	{
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, BlockUnsupportedOperationsWithoutSnapshotDoesNotBlockInvoke)
	{
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, BlockUnsupportedOperationsWithUnsupportedOpIdReturnsRemoteNotCapable)
	{
		InitializeConnectedEndpoints();
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, BlockUnsupportedOperationsWithSupportedOpIdSendsInvoke)
	{
		InitializeConnectedEndpoints();
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, NeverBlockWithSnapshotDoesNotBlockInvoke)
	{
		InitializeConnectedEndpoints();
		m_client.SetRemoteModuleCapabilities(BuildRemoteSnapshotWithoutGetSettings());
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, ClearRemoteCapabilitiesStopsBlocking)
	{
		InitializeConnectedEndpoints();
		m_client.SetRemoteModuleCapabilities(BuildRemoteSnapshotWithoutGetSettings());
		m_client.SetOperationBlockPolicy(SnaccOperationBlockPolicy::BlockUnsupportedOperations);
	...
	TEST_F(snacclib_ClientInvokeBlockPolicyRuntimeTest, IsSupportedOperationReflectsAppliedSnapshot)
	{
