...
namespace snacclib
{
	...
	TEST(snacclib_ModuleRegistryTest, StaticRegistrationPopulatesOnlyTargetLookup)
	{
	...
	TEST(snacclib_ModuleRegistryTest, RegisteredMetadataMatchesLoadedModuleSnapshot)
	{
	...
	TEST(snacclib_ModuleRegistryTest, RuntimeFixtureKeepsClientAndServerRegistriesSeparate)
	{
