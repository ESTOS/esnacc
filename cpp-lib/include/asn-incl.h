...
#define BEncTag1(b, class, form, code)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
	1;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
	b.PutByteRvs(static_cast<unsigned char>(static_cast<unsigned char>(class) | static_cast<unsigned char>(form) | static_cast<unsigned char>(code)))
...
// ste 4.11.14 AsnSystemTime own implementation because JSON and BER differ
...
// ste 4.11.14 AsnOptionalParam own implementation because JSON and BER differ
