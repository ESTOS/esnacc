// Run: npx tsx typescript/TSModuleCapabilities.test.ts
import assert from "node:assert/strict";
import test from "node:test";
import { buildRemoteModuleCapabilities, buildRemoteModuleCapabilitiesFromAsn } from "./stub/TSModuleCapabilities.js";
