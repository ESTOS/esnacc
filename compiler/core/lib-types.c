 ...
 *
 * $Header: /develop30/common/esnacc1.7/SNACC/compiler/core/lib-types.c,v 1.1.1.1 2005/04/14 14:59:43 \ste Exp $
 * $Log: lib-types.c,v $
...
LibType libBERTypesG[BASICTYPE_RELATIVE_OID + 1] = {{BASICTYPE_UNKNOWN, NO_TAG_CODE, NULL_FORM, NULL},
													...
													{BASICTYPE_OCTETCONTAINING, OCTETSTRING_TAG_CODE, ANY_FORM, NULL},
													{BASICTYPE_BITCONTAINING, BITSTRING_TAG_CODE, PRIM, NULL},
													{BASICTYPE_RELATIVE_OID, RELATIVE_OID_TAG_CODE, PRIM, NULL}};

/* DER Types */
LibType libDERTypesG[BASICTYPE_RELATIVE_OID + 1] = {{BASICTYPE_UNKNOWN, NO_TAG_CODE, NULL_FORM, NULL},
													{BASICTYPE_BOOLEAN, BOOLEAN_TAG_CODE, PRIM, NULL},
													{BASICTYPE_INTEGER, INTEGER_TAG_CODE, PRIM, NULL},
