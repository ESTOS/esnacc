 ...
 *
 * This file comes from https://github.com/graphitemaster/incbin and is provided there
 * without any limitations as unlicensed.
 */
#ifndef INCBIN_HDR
#define INCBIN_HDR
#include <limits.h>
...
#define INCBIN_COMMON(TYPE, NAME, FILENAME, TERMINATOR)                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
	__asm__(INCBIN_SECTION INCBIN_GLOBAL_LABELS(NAME, DATA) INCBIN_ALIGN_HOST INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME INCBIN_STYLE_STRING(DATA) ":\n" INCBIN_MACRO " \"" FILENAME "\"\n" TERMINATOR INCBIN_GLOBAL_LABELS(NAME, END) INCBIN_ALIGN_BYTE INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME INCBIN_STYLE_STRING(END) ":\n" INCBIN_BYTE "1\n" INCBIN_GLOBAL_LABELS(NAME, SIZE)                                                                                                            \
