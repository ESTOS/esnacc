...
#define SNACC_VALIDATION_RULES_LIST(X)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
	X(UNIQUE_OPERATION_ID, 1, "unique-operation-id", "Validates that operation IDs are unique within the module")                                                                                                                                                                                                                                                                                                                                                                                                  \
	X(ROSE_PAYLOAD_EXTENDABLE, 2, "rose-payload-extendable", "ROSE argument, result, and error types must be SEQUENCE or CHOICE")                                                                                                                                                                                                                                                                                                                                                                                  \
	X(UNIFORM_OPERATION_ERROR, 4, "uniform-operation-error", "All ROSE operation ERROR types in a module must be the same type")                                                                                                                                                                                                                                                                                                                                                                                   \
	X(SEQUENCE_HAS_ELLIPSIS, 8, "sequence-has-ellipsis", "SEQUENCE types must end with ... for extensibility")                                                                                                                                                                                                                                                                                                                                                                                                     \
	X(PRIMITIVE_TYPE_WHITELIST, 16, "primitive-type-whitelist", "Only ASN.1 primitive types listed in esnacc_whitelist.txt are allowed")                                                                                                                                                                                                                                                                                                                                                                           \
