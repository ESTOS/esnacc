 ...
 *
 * $Header: /develop30/common/esnacc1.7/SNACC/compiler/core/link-values.c,v 1.1.1.1 2005/04/14 14:59:43 \ste Exp $
 * $Log: link-values.c,v $
 ...
 */
int LinkValueRefs PARAMS((m), ModuleList* m)
{
	Module* currMod;
	TypeDef* td;
	ValueDef* vd;
 ...
 * lowercase letter
 */
void ValueLinkImportLists PARAMS((m), ModuleList* m)
{
	Module* currMod;
	ValueDef* v;
...
void ValueLinkType PARAMS((m, currMod, head, t), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t)
{
	Tag* tag;
...
void ValueLinkTag PARAMS((m, currMod, head, tag), ModuleList* m _AND_ Module* currMod _AND_ Type* t _AND_ Tag* tag)
{
...
void ValueLinkElmtTypes PARAMS((m, currMod, head, e), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ NamedTypeList* e)
{
	NamedType* n;
...
void ValueLinkElmtType PARAMS((m, currMod, head, n), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ NamedType* n)
{
	if (n != NULL)
 ...
 */
void ValueLinkSubtypes PARAMS((m, currMod, head, currType, s), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* currType _AND_ Subtype* s)
{
	Subtype* sElmt;
...
void ValueLinkSubtypeValue PARAMS((m, currMod, head, currType, s), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* currType _AND_ SubtypeValue* s)
{
	...
	switch (s->choiceId)
	{
		...
		case SUBTYPEVALUE_VALUERANGE:
			ValueLinkValue(m, currMod, NULL, currType, s->a.valueRange->lowerEndValue->endValue);
			ValueLinkValue(m, currMod, NULL, currType, s->a.valueRange->upperEndValue->endValue);
			break;
...
void ValueLinkNamedElmts PARAMS((m, currMod, head, t, v), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ ValueDefList* v)
{
	ValueDef* vd;
...
void ValueLinkValueDef PARAMS((m, currMod, v), ModuleList* m _AND_ Module* currMod _AND_ ValueDef* v)
{
	if (v == NULL)
		return;
...
void ValueLinkBasicValue PARAMS((m, currMod, head, valuesType, v, bv), ModuleList* m _AND_ Module* currMod _AND_ ValueDef* head _AND_ Type* valuesType _AND_ Value* v _AND_ BasicValue* bv)
{
	...
	switch (bv->choiceId)
	{
		...
		case BASICVALUE_IMPORTVALUEREF:
			...
			if (bv->a.importValueRef->moduleName != NULL)
			{
				...
				{
					if (impElmt->resolvedRef->choiceId != IMPORTELMTCHOICE_VALUE)
 ...
 *
 */
void ValueLinkOid PARAMS((m, currMod, head, v, oid), ModuleList* m _AND_ Module* currMod _AND_ ValueDef* head _AND_ Value* v _AND_ OID* oid)
{
	/*
	...
	for (; oid != NULL; oid = oid->next)
	{
		if (oid->valueRef != NULL)
		{
			...
			if ((oid->valueRef->basicValue->choiceId != BASICVALUE_LOCALVALUEREF) && (oid->valueRef->basicValue->choiceId != BASICVALUE_IMPORTVALUEREF))
			{
...
void ValueLinkRosOperationMacroType PARAMS((m, currMod, head, t, bt, op), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ RosOperationMacroType* op)
{
	TypeOrValue* tOrV;
...
void ValueLinkRosErrorMacroType PARAMS((m, currMod, head, t, bt, err), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ RosErrorMacroType* err)
{
	if ((err != NULL) && (err->parameter != NULL))
		ValueLinkType(m, currMod, head, err->parameter->type);
} /* ValueLinkRosErrorMacroType */

void ValueLinkRosBindMacroType PARAMS((m, currMod, head, t, bt, bind), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ RosBindMacroType* bind)
{
	if (bind != NULL)
	{
...
void ValueLinkRosAseMacroType PARAMS((m, currMod, head, t, bt, ase), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ RosAseMacroType* ase)
{
	Value* v;
...
void ValueLinkRosAcMacroType PARAMS((m, currMod, head, t, bt, ac), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ RosAcMacroType* ac)
{
	Value* v;
	OID* oid;
...
void ValueLinkMtsasExtensionsMacroType PARAMS((m, currMod, head, t, bt, exts), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ MtsasExtensionsMacroType* exts)
{
	Value* v;
...
void ValueLinkMtsasExtensionMacroType PARAMS((m, currMod, head, t, bt, ext), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ MtsasExtensionMacroType* ext)
{
...
void ValueLinkMtsasTokenMacroType PARAMS((m, currMod, head, t, bt, tok), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ MtsasTokenMacroType* tok)
{
	if (tok != NULL)
		ValueLinkType(m, currMod, head, tok->type);
} /* ValueLinkMtsasTokenMacroType */

void ValueLinkMtsasTokenDataMacroType PARAMS((m, currMod, head, t, bt, tok), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ MtsasTokenDataMacroType* tok)
{
	if (tok != NULL)
		ValueLinkType(m, currMod, head, tok->type);
...
void ValueLinkAsnObjectMacroType PARAMS((m, currMod, head, t, bt, obj), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ AsnObjectMacroType* obj)
{
	AsnPort* ap;
...
void ValueLinkAsnPortMacroType PARAMS((m, currMod, head, t, bt, p), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ AsnPortMacroType* p)
{
	TypeOrValue* tOrV;
...
void ValueLinkAsnAbstractBindMacroType PARAMS((m, currMod, head, t, bt, bind), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ AsnAbstractBindMacroType* bind)
{
	AsnPort* ap;
...
void ValueLinkSnmpObjectTypeMacroType PARAMS((m, currMod, head, t, bt, ot), ModuleList* m _AND_ Module* currMod _AND_ TypeDef* head _AND_ Type* t _AND_ BasicType* bt _AND_ SnmpObjectTypeMacroType* ot)
{
	TypeOrValue* tOrV;
