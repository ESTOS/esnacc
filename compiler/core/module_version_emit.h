...
extern "C"
{
	 ...
	 */
	void EmitAnnotatedModuleVersionFields(FILE* out, ModuleVersionEmitStyle style, const char* szModuleNameUpper, const char* indent, int majorVersion, long long patchUnix);
