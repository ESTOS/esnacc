...
// [PrintTSRootTypes]
export const MODULE_NAME = "SNACCROSE";
// Module version metadata for this ASN.1 compile (see SnaccModuleVersions.h). Semver: MAJOR.MINOR.PATCH.
// Newest @added date in this module (ISO); same source as MODULE_PATCH_VERSION.
export const MODULE_LASTCHANGE = "1970-01-01T00:00:00Z";
// API deprecation baseline from deprecatedbaseline.txt or -nodeprecated (ISO).
export const MODULE_BASELINE = "1970-01-01T00:00:00Z";
// Semver major: baseline as YYYYMMDD or legacy integer; 0 when no dated baseline.
export const MODULE_MAJOR_VERSION = 0;
// Semver minor placeholder; always 0 in current esnacc releases.
export const MODULE_MINOR_VERSION = 0;
// Semver patch: newest @added in this module as YYYYMMDD (module activity, not a bugfix bump).
export const MODULE_PATCH_VERSION = 0;
// "{major}.{minor}.{patch}" label for handshake and logging.
...
export class ROSEError {
	...
	public static getASN1Schema(params?: asn1ts.ConstructedParams): asn1ts.Sequence {
		return new asn1ts.Sequence({
			...
			...params,
			value: [
				new asn1ts.Sequence({ value: [new asn1ts.Utf8String({ name: "sessionID" })], name: "sessionID", idBlock: { optionalID: 1 }}),
				new asn1ts.Integer({ name: "invokedID" }),
	...
	public static getASN1Schema(params?: asn1ts.ConstructedParams): asn1ts.Sequence {
		return new asn1ts.Sequence({
			...
			value: [
				...
				new asn1ts.Sequence({ value: [new asn1ts.Utf8String({ name: "operationName" })], name: "operationName", idBlock: { optionalID: 2 }}),
				new asn1ts.Sequence({ value: [ROSEAuthRequest.getASN1Schema({ name: "authentication" })], name: "authentication", idBlock: { optionalID: 3 }}),
				new asn1ts.Integer({ name: "timeout", idBlock: { optionalID: 4 } }),
	...
	public static getASN1Schema(params?: asn1ts.ConstructedParams): asn1ts.Sequence {
		return new asn1ts.Sequence({
			...
			value: [
				...
				new asn1ts.Sequence({ value: [ROSEAuthResult.getASN1Schema({ name: "authentication" })], name: "authentication", idBlock: { optionalID: 4 }})
			]
		});
	}
