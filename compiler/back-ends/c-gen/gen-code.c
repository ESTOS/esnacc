 ...
 *
 * $Header: /develop30/common/esnacc1.7/SNACC/compiler/back-ends/c-gen/gen-code.c,v 1.2 2008/04/08 10:47:15 \ste Exp $
 * $Log: gen-code.c,v $
 * Revision 1.2  2008/04/08 10:47:15  \ste
	...
	CRules *r)
{
	...
	FOR_EACH_LIST_ELMT (osa, m->objSetAssignments)
	{
		...
		FOR_EACH_LIST_ELMT (tOrV, osa->objectNameList)		// Deepak: 24/Mar/2003
		{
			...
			snprintf(osaName, "%s[%d]", Asn1ValueName2CValueName(osa->objectSetName), currOsa);
			FOR_EACH_LIST_ELMT (oaf, oa->objectAssignmentField)
    ...
    Module *m)
{
	...
	// char szBuffer[512] = {0};
	// ctime_s(szBuffer, 512, &t);
	// fprintf (src, " *    This file was generated by Coral WinSnacc on %s", szBuffer);
    ...
    Module *m)
{
	...
	// char szBuffer[512] = { 0 };
	// ctime_s(szBuffer, 512, &t);
	// fprintf(f, " *    This .h file was generated by Coral WinSnacc on %s", szBuffer);
