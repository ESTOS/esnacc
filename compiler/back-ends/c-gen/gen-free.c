 ...
 *
 * $Header: /develop30/common/esnacc1.7/SNACC/compiler/back-ends/c-gen/gen-free.c,v 1.1.1.1 2005/04/14 14:59:43 \ste Exp $
 * $Log: gen-free.c,v $
	...
	char* varName)
{
	...
	MakeVarPtrRef(genFreeCRulesG, td, parent, e, varName, elmtVarRef, MAX_VAR_REF);
