...
// If this is a local type ref or imported type ref, it walks up until it is no longer an imported or local type ref
...
// If this is a local type ref or imported type ref, it returns the type one level up
BasicType* GetBaseBasicType(BasicType* type, const char** szName);

// If this is a local type ref or imported type ref, it returns the enum type one level up
enum BasicTypeChoiceId GetBaseBasicTypeChoiceId(BasicType* basicType);

// If this is a sequenceof or setof, it determines the underlying type
