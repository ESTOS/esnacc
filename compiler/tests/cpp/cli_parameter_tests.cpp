...
namespace compiler
{
	...
	TEST(Compiler_CliParameterTest, NodeprecatedAutoUsesNewestDeprecatedDate)
	{
		TestWorkDir workDir;
	...
	TEST(Compiler_CliParameterTest, NodeprecatedDateRemovesSymbolsDeprecatedOnOrBeforeCutoff)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, NodeprecatedDateBeforeDeprecationKeepsSymbol)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, CompileSucceedsWithoutDeprecatedBaselineFile)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, CommentOnlyDeprecatedBaselineBehavesLikeMissingFile)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, InterfaceVersionDateSetsMajorVersionInGeneratedHeader)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, InterfaceVersionLegacyIntegerDoesNotAutoFilterDeprecated)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
	...
	TEST(Compiler_CliParameterTest, InterfaceVersionLegacyIntegerLabelsGeneratedMajorVersion)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
		workDir.WriteDeprecatedBaseline(FixtureDirectory() / "deprecatedbaseline_legacy.txt");
	...
	TEST(Compiler_CliParameterTest, NodeprecatedDateOverridesInterfaceVersionFile)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
		workDir.WriteDeprecatedBaseline(FixtureDirectory() / "deprecatedbaseline_date.txt");
	...
	TEST(Compiler_CliParameterTest, NoprivateRemovesPrivateOperationsFromFilterOutput)
	{
		TestWorkDir workDir;
		workDir.CopyBaselineModule();
