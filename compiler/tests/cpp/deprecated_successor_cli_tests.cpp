...
namespace compiler
{
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, ValidCanonicalNotationProducesNoSuccessorWarnings)
	{
		TestWorkDir workDir;
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, LegacyAndMissingSuccessorsWarnWithoutFailingCompile)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, LegacyOperationWarnsWithSymbolNameInMessage)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, LoadedCrossModuleSuccessorProducesNoWarning)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, MissingLoadedCrossModuleSuccessorWarns)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Ref.asn1");
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, LoadedUcWebSuccessorProducesNoWarning)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
	...
	TEST(Compiler_DeprecatedSuccessorCliTest, EnumMemberDeprecationSkipsSuccessorValidation)
	{
		TestWorkDir workDir;
		workDir.CopyFixture(FixtureDirectory() / "DeprecatedSuccessor_Test.asn1");
