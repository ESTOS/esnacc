...
namespace compiler
{
	...
	class Compiler_InterfaceBaselineTest : public ::testing::Test
	{
	protected:
		void SetUp() override
		{
	...
	TEST_F(Compiler_InterfaceBaselineTest, LoadDeprecatedBaselineFileIgnoresMissingFile)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, LoadDeprecatedBaselineFileIgnoresCommentOnlyFile)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, GetInterfaceBaselineUnixTimestampUsesDeprecatedCutoff)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, ParseDateBaselineSetsMajorAndDeprecatedCutoff)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, ParseLegacyIntegerSetsMajorOnly)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, ParseDateWithAutoResolveDefersDeprecatedCutoff)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, CliNodeprecatedDateDoesNotApplyFileBaselineCutoff)
	{
	...
	TEST_F(Compiler_InterfaceBaselineTest, ApplyDeprecatedCutoffUnixAlignsMajorVersionLabel)
	{
