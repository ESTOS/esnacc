...
export class ENetUC_Settings_ManagerROSE extends ROSEBase implements IInvokeHandler, IENetUC_Settings_ManagerROSE {
	...
	// [PrintTSROSERemoveHandler]
	/**
	 * Removes a previously registered handler for all operations in this module
	 */
	public removeHandler(): void {
		this.transport.unregisterOperation(OperationIDs.OPID_asnGetSettings);
		this.transport.unregisterOperation(OperationIDs.OPID_asnSetSettings);
		this.transport.unregisterOperation(OperationIDs.OPID_asnGetSettingsOld);
		this.transport.unregisterOperation(OperationIDs.OPID_asnSettingsChanged);
		this.transport.unregisterModuleVersion("ENetUC_Settings_Manager");
	}
