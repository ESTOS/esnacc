...
export class ENetUC_Event_ManagerROSE extends ROSEBase implements IInvokeHandler, IENetUC_Event_ManagerROSE {
	...
	public removeHandler(): void {
		this.transport.unregisterOperation(OperationIDs.OPID_asnCreateFancyEvents);
		this.transport.unregisterOperation(OperationIDs.OPID_asnFancyEvent);
		this.transport.unregisterModuleVersion("ENetUC_Event_Manager");
	}
