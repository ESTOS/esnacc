...
In GitHub Actions, the same flow is driven by CMake targets `snacc-ts-prepare`, `snacc-ts-all`, and the `typescript_run_ts_microservice_sample_node_client_against_node_server` ctest entry.
